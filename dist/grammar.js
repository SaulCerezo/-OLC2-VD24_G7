...
function peg$parse(input, options) {
    ...
    var peg$r3 = /^[+*?]/;
    var peg$r4 = /^[!&]/;
    var peg$r5 = /^[a-zA-Z_]/i;
    var peg$r6 = /^[a-zA-Z0-9_]/i;
    var peg$r7 = /^[0-9]/;
    var peg$r8 = /^["]/;
    var peg$r9 = /^[']/;
    var peg$r10 = /^[^[\]\-]/;
    ...
    var peg$e24 = peg$classExpectation([["a", "z"], ["A", "Z"], "_"], false, true);
    var peg$e25 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "_"], false, true);
    ...
    function peg$parseconcatenacion() {
        var s0, s1, s2, s3, s4, s5;
        s0 = peg$currPos;
        s1 = peg$parseetiquetada();
        if (s1 !== peg$FAILED) {
            s2 = [];
            s3 = peg$currPos;
            s4 = peg$parse_();
            s5 = peg$parseetiquetada();
            if (s5 !== peg$FAILED) {
                s4 = [s4, s5];
                s3 = s4;
            }
    ...
    function peg$parseexpresion() {
        ...
        if (s0 === peg$FAILED) {
            s0 = peg$parseregla();
            if (s0 === peg$FAILED) {
                s0 = peg$parseasercion();
                if (s0 === peg$FAILED) {
                    s0 = peg$parsetexto();
                    if (s0 === peg$FAILED) {
                        s0 = peg$currPos;
                        s1 = peg$parsesubexpresion();
                        if (s1 !== peg$FAILED) {
                        ...
                        if (s0 === peg$FAILED) {
                            s0 = peg$parsecero_o_mas();
                            if (s0 === peg$FAILED) {
                                s0 = peg$parseuna_o_mas();
                                if (s0 === peg$FAILED) {
                                    s0 = peg$parsecero_o_una();
                                    if (s0 === peg$FAILED) {
                                        s0 = peg$parseparseo();
                                        if (s0 === peg$FAILED) {
                                            s0 = peg$parse_Punto_();
                                            if (s0 === peg$FAILED) {
                                                s0 = peg$parsefin_entrada();
                                                if (s0 === peg$FAILED) {
                                                    s0 = peg$parserepeticiones();
                                                }
                                            }
                                        }
                                    }
    ...
    function peg$parserepeticiones() {
        var s0, s1, s2, s3, s4, s5;
        s0 = peg$currPos;
    ...
    function peg$parsecontenido_rango() {
        var s0, s1, s2, s3;
        s0 = peg$currPos;
        s1 = input.charAt(peg$currPos);
        if (peg$r10.test(s1)) {
    ...
    function peg$parseconjunto() {
        ...
        if (s1 !== peg$FAILED) {
            s2 = [];
            s3 = peg$parsecontenido_conjunto();
            if (s3 !== peg$FAILED) {
                while (s3 !== peg$FAILED) {
                    s2.push(s3);
                    s3 = peg$parsecontenido_conjunto();
    ...
    function peg$parsecontenido_conjunto() {
        var s0, s1;
        s0 = [];
        s1 = input.charAt(peg$currPos);
        if (peg$r11.test(s1)) {
