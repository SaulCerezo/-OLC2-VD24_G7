...
function peg$parse(input, options) {
    ...
    var peg$f1 = function (var_, expr) {
        array_reglas[var_] = expr;
        return { var_, expr };
    };
    var peg$f2 = function (primero, lista) {
        return [primero, ...lista.map(([_, cadena]) => cadena)];
    };
    var peg$f3 = function (variable_referencia) {
        if (array_reglas[variable_referencia]) {
            return `Regla: ${variable_referencia}`;
        }
        else {
            throw new Error(`Regla no definida: ${variable_referencia}`);
        }
    };
    var peg$f4 = function () {
    ...
    var peg$f6 = function (rec) {
        return [" ", rec, rec + rec, rec + rec + rec];
    };
    var peg$f7 = function (rec) {
        return [rec, rec + rec, rec + rec + rec];
    };
    var peg$f8 = function (rec) {
        return [" ", rec];
    };
    var peg$f9 = function () {
        return text();
    ...
    function peg$parsecadena() {
        ...
        if (s0 === peg$FAILED) {
            ...
            if (s0 === peg$FAILED) {
                ...
                if (s0 === peg$FAILED) {
                    s0 = peg$parsecero_o_uno();
                    if (s0 === peg$FAILED) {
                        s0 = peg$parseopciones();
                        if (s0 === peg$FAILED) {
    ...
    function peg$parsecero_o_mas() {
        ...
        s0 = peg$currPos;
        s1 = peg$parse_();
        s2 = peg$parseopciones();
        if (s2 === peg$FAILED) {
            s2 = peg$parseconcatenacion();
            if (s2 === peg$FAILED) {
                s2 = peg$parsequoted();
                if (s2 === peg$FAILED) {
                    s2 = peg$parserange();
